  ...
  return (
    <div className="container mx-auto p-4 md:p-8 max-w-4xl">
      ...
      <div className="space-y-4">
        <pre><strong>Last Updated:</strong> August 15, 2025</pre>
        <p>Thank you for your purchase from AutoMeta AI.</p>
        ...
        <p>If you have initiated a payment but have not completed it, you can simply cancel the process or close the payment window. No charges will be made, and no file will be delivered. Your request information may be stored with a <b>pending</b> status for internal analytics.</p>
