      ...
      <div className="space-y-12">
        {categories.map((category) => (
          <section key={category._id}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {category.documents.map((doc, index) => (
              // 3. Change from <button> to <div> and remove the onClick
              <div
                key={doc._id}
              ...
              >
                ...
                {/* Add flex-grow to make this div take up remaining space */}
                <div className="p-4 flex flex-col flex-grow">
                  <h2 className="text-xl font-semibold mb-2">{doc.title}</h2>
                  <p className="text-gray-600 text-sm mb-4 line-clamp-2 flex-grow">{doc.description}</p>
                  <p className="font-semibold text-lg">₹{doc.price} INR</p>
                  
                  {/* 4. Add the new button here */}
